...
public class DatabaseCreation {
    ...
    public void create() throws SQLException{
        ...
        queries.add("CREATE TABLE IF NOT EXISTS PrivateWorlds (`ID` INTEGER, `WorldName` TEXT, `ChunkID` TEXT, `Location` TEXT , `ParticleEffect` TEXT, `Quantity` INTEGER,PRIMARY KEY(`ID`))");
        queries.add("CREATE TABLE IF NOT EXISTS Plots (`ID` INTEGER, `WorldName` TEXT, `ChunkID` TEXT, `Location` TEXT , `ParticleEffect` TEXT, `Quantity` INTEGER,PRIMARY KEY(`ID`))");
